...
class ViewController: UIViewController {
    ...
    @objc func routeButtonTapped(){
        ...
        for index in 0...annotationsArray.count - 2 {
            creatrDirectionRequest(startCoordinate: annotationsArray[index].coordinate, destinationCoordinate: annotationsArray[index + 1].coordinate)
        }
    ...
    private func creatrDirectionRequest(startCoordinate: CLLocationCoordinate2D, destinationCoordinate: CLLocationCoordinate2D) {
